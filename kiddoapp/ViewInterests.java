...
public class ViewInterests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li=(ListView) findViewById(R.id.li6);
...
//                        Toast.makeText(getApplicationContext(), response, Toast.LENGTH_LONG).show();
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    int_id[i] = u.getString("int_id");

                                }
                                li.setAdapter( new customviewinterests(getApplicationContext(),tag,description,int_id));//custom_view_service.xml and li is the listview object
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("id", sh.getString("chid",""));//passing to python
                return params;
            }
        };
